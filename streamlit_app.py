...
def show_landing_page():
    ...
    /* Set background and remove padding */
    html, body, .stApp {
    ...
    try:
        ...
        html, body { overflow-x: hidden !important; overflow-y: auto !important; height: auto !important; min-height: 100vh !important; background: #06060f; }
        ...
        st.info("Ensure the 'landing' folder contains index.html and style.css")
